...
## 2026-08-17 — Read-only ReactPy-Django analyst UI

- The ReactPy-Django app may query already-persisted local evidence, derived correlations, process health, and an optional local flow store.
- It must not tail live Suricata/Zeek logs, open MikroTik/RouterOS, create stores, recover ledgers, start collectors, or deploy signatures. Missing or unreadable sources stay visible as unknown.
